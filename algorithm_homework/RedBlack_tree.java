...
class RedBlack_tree {
	...
	private Node nullNode; // define null node
	...
	public static void main(String[] args) {
		...
		// Create instance of the createRedBlackTree class and pass minimum integer
		// value to the constructor to make it header node
		RedBlack_tree obj = new RedBlack_tree(Integer.MIN_VALUE);
		char choice;
