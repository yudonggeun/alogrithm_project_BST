...
public class RedBlack_tree implements Tree {
	...
	// Inserts z into the appropriate position in the RedBlack_tree while
	...
	// of the RedBlack_tree properties
	// Fixes up the violation of the RedBlack_tree properties that may have
	// been caused during insert(z)
	private void insertFixup(Node z){

		Node y = nil;
		// While there is a violation of the RedBlack_tree properties..
	...
	// Remove's z from the RedBlack_tree rooted at root
	public void remove(Node v){

		Node z = searchNode(v.key);
		...
		// RedBlack_tree properties so call removeFixup()
	...
	public long search(Integer target) {
		...
		return searchNode(target) == null ? -1 : System.currentTimeMillis() - time;
	}
	...
	public int numGreater(Integer key){
	...
	public int numSmaller(Integer key){
	...
	public int findNumGreater(Node node, Integer key){
     ...
     */
    public List<Integer> getGreaterThan(Integer key, Integer maxReturned) {
    ...
    private void getGreaterThan(Node node, Integer key,
                                List<Integer> list) {
        if (isNil(node)) {
            return;
	...
	public int findNumSmaller(Node node, Integer key){
	...
	// Return's the # of nodes including the root which the RedBlack_tree
	// rooted at root has.
	public int size(){
